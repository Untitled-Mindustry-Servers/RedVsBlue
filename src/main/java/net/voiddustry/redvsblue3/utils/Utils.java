...
public class Utils {
    ...
    public static void sendBundled(String key) {
        for (Player player : Groups.player) {
            String text = Bundle.get(key, player.locale);
            player.sendMessage(text);
        }
    }

    public static void sendBundled(String key, Object... objects) {
        for (Player player : Groups.player) {
            String text = Bundle.format(key, Bundle.findLocale(player.locale), objects);
            player.sendMessage(text);
        }
    }
